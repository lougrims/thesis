...
\begin{equation}
  Q = \frac{L'}{MgL} = \frac{\frac{1}{2} \rho V^{2} C_l^* }{Mg}
...
\begin{figure}[h]
  ...
  \caption{Comparison with Lissaman's \cite{Lissaman2007neutral} non-dimmesional normal force $N$ for a $4T$ long vertical gust}
