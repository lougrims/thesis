...
\begin{figure}[h]
  ...
  \end{center}
  \caption{Unsteady effects of sinusoidal pitching on the drag}
  \label{fig:Pitching_allcases_Cd_12}
\end{figure}

\par Similarly another set of acquisitions is made at a mean angle of 10 degrees.
...
\begin{figure}[h]
  \begin{center}
    \scalebox{0.6}  
    {\includegraphics{./Figures/Pitching_allcases_CL_10_amp_2.eps}}
  \end{center}
  \caption{Unsteady effects of sinusoidal pitching on the lift}
...
\begin{figure}[h]
  \begin{center}
    \scalebox{0.6}  
    {\includegraphics{./Figures/Pitching_allcases_CD_10_amp_2.eps}}
  \end{center}
  \caption{Unsteady effects of sinusoidal pitching on the drag}
  \label{fig:Pitching_allcases_Cd_10}
\end{figure}

The two time constants are determined manually.
$\tau_1$ is found to be 
