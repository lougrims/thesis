...
The unsteady model is expected to produce two effects on the lift and drag characteristics that can influence the optimization process.
The first is the that the unsteady lift can reach values that are impossible to achieve in the quasi-steady case.
...
The second effect is the delay between the angle of attack variations and the flow response.
