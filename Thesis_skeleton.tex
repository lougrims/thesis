...
\Chapter{Modelization of the Lift coefficient under unsteady pitching motion} \label{Ch:gkmodel}

\input{Chapters/Gk_model.tex}
%servo drive and stuff
\Chapter{Trajectory optimization with the unsteady model}
\input{Chapters/unsteady_eni_opt.tex}
\Chapter{CONCLUSION}
...
\Appendix{Goman Khrabrov model Matlab \textregistered implementation} \label{ch:GK_code}
